# Description: Configuration file for the backend server
...
class Config:
    ...
    MONGO_URI = os.getenv("MONGODB_URI") # MongoDB URI
    ...
    # URL for the USAFacts website to be used in the web scraper
